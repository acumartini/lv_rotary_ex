 ...
 * Author: Adam Martini
 *
 * Created on April 26, 2020, 10:01 PM
 */
...
class TouchPoint : public TS_Point
{
public:
  TouchPoint(): TS_Point() {}
  TouchPoint(int16_t x, int16_t y, int16_t z): TS_Point(x, y, z) {}
};

class TouchScreen : public Adafruit_STMPE610
{
  SPIClass *_spi;
  int8_t _CS;

public:
  TouchScreen(uint8_t cspin, SPIClass *theSPI = &SPI);
